...
class Node:
    def __init__(self,row,col,size,total_rows):
        ...
        self.size = size #szerokoœæ i wysokoœæ bloczku
        self.x = row*size #pozycja na ekranie X
        self.y = col*size #pozycja na ekranie Y
        self.color = WHITE #kolor bloku, jeœli bia³y to nie by³ on sprawdzany
        self.total_rows = total_rows #³¹czna iloœæ wierszy w gridzie

        self.neighbours = [] #lista s¹siadów z danego Node
    ...
    #################LOGIKA KOLORÓW
    def is_checked(self):
        return self.color == RED #jeœli dany Node by³ sprawdzony to przypisano mu kolor RED
